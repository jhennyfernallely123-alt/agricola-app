...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-pencil"></i> Editar Plan de Cultivo</h1>
        <form action="{{ route('planes-cultivo.update', $plan) }}" method="POST" class="form-agricola">
            @csrf @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" value="{{ old('fecha_inicio', $plan->fecha_inicio) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="fecha_fin_prevista" id="fecha_fin_prevista" class="form-control" value="{{ old('fecha_fin_prevista', $plan->fecha_fin_prevista) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="objetivo_produccion" id="objetivo_produccion" class="form-control" value="{{ old('objetivo_produccion', $plan->objetivo_produccion) }}">
                @error('objetivo_produccion') <div class="text-danger mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div> @enderror
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Actualizar Plan de Cultivo</button>
