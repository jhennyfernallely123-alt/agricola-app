...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-plus-lg"></i> Nueva Etapa Fenológica</h1>
        <form action="{{ route('etapas-fenologicas.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="requerimientos_especificos" id="requerimientos_especificos" class="form-control" rows="3">{{ old('requerimientos_especificos') }}</textarea>
                @error('requerimientos_especificos') <div class="text-danger mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div> @enderror
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Crear Etapa Fenológica</button>
