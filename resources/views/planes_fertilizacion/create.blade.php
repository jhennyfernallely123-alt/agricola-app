...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-plus-lg"></i> Nuevo Plan de Fertilización</h1>
        <form action="{{ route('planes-fertilizacion.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="insumo_agricola_id" id="insumo_agricola_id" class="form-select" required>
                    ...
                    <option value="{{ $fertilizante->id }}" {{ old('insumo_agricola_id') == $fertilizante->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <select name="etapa_fenologica_id" id="etapa_fenologica_id" class="form-select">
                    ...
                    <option value="{{ $etapa->id }}" {{ old('etapa_fenologica_id') == $etapa->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="dosis" id="dosis" class="form-control" value="{{ old('dosis') }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="metodo" id="metodo" class="form-control" value="{{ old('metodo') }}">
                @error('metodo') <div class="text-danger mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div> @enderror
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Crear Plan de Fertilización</button>
