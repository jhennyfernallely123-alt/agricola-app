...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-plus-lg"></i> Nueva Parcela</h1>
        <form action="{{ route('parcelas.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="historial_uso" id="historial_uso" class="form-control" rows="3">{{ old('historial_uso') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="analisis_suelo" id="analisis_suelo" class="form-control" rows="3">{{ old('analisis_suelo') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="potencial_productivo" id="potencial_productivo" class="form-control" value="{{ old('potencial_productivo') }}">
                @error('potencial_productivo') <div class="text-danger mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div> @enderror
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Crear Parcela</button>
