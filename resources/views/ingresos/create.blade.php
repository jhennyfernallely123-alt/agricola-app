...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-plus-lg"></i> Nuevo Ingreso</h1>
        <form action="{{ route('ingresos.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
                <label for="fuente" class="form-label">Fuente</label>
                <input type="text" name="fuente" id="fuente" class="form-control" value="{{ old('fuente') }}" required>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Registrar Ingreso</button>
