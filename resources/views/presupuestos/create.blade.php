...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-plus-lg"></i> Nuevo Presupuesto</h1>
        <form action="{{ route('presupuestos.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="monto_total" id="monto_total" class="form-control" value="{{ old('monto_total') }}" step="0.01" min="0" required>
                @error('monto_total') <div class="text-danger mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div> @enderror
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Crear Presupuesto</button>
