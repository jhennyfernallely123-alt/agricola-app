...
<div class="container">
    <div class="tarjeta-crud">
        <h1><i class="bi bi-plus-lg"></i> Nuevo Sistema de Riego</h1>
        <form action="{{ route('sistemas-riego.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="fuente" id="fuente" class="form-control" value="{{ old('fuente') }}">
                @error('fuente') <div class="text-danger mt-1"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div> @enderror
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Crear Sistema de Riego</button>
