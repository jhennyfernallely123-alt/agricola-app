...
<div class="container">
    <div class="tarjeta-crud">
        ...
        <form action="{{ route('clientes.store') }}" method="POST" class="form-agricola">
            @csrf
            <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Crear Cliente</button>
